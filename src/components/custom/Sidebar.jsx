...
import { FlameIcon, GemIcon, HandCoinsIcon, Handshake, Key,MemoryStick, Users, ChartPie } from 'lucide-react';
...
function Sidebar() {
    ...
    return (
            <div className="w-88 text-white bg-[#033f66] border-r min-h-screen h-full p-4">
